...
// void IngredientMap::fill_tiles(const vector<string> &map_data) {
//     unsigned int i = -1, j;
...
// IngredientMap::IngredientMap(const vector<string> &map_data) : num_cols(map_data[0].size()), num_rows(map_data.size()) {
//     fill_tiles(map_data);
// };
